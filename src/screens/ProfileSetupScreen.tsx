// src/screens/ProfileSetupScreen.tsx (PARÇA 1)
...
export default function ProfileSetupScreen(): React.ReactElement {
  ...
  const initialAvatarId = user?.avatarId || (avatars && avatars?.[0]?.id) || 'avatar-1';
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          <Text style={styles.welcome}>Kelimedate'e Hoş Geldin</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.genderRow}>
            ...
            <Pressable style={genderButtonStyle('belirtmek_istemiyorum')} onPress={() => setGender('belirtmek_istemiyorum')}>
              <Text style={[styles.genderText, gender === 'belirtmek_istemiyorum' && styles.genderTextActive]}>
...
const styles = StyleSheet.create({
  ...
  genderText: { color: '#cbd5e1', fontWeight: '700', fontSize: 12, textAlign: 'center' },
